...
public class JdbcMealRepositoryImpl implements MealRepository {
    ...
    public Meal get(int id, int userId) {
        List<Meal> meals = jdbcTemplate.query("SELECT * FROM meals WHERE id=?", MEAL_ROW_MAPPER, id);
    ...
    private List<Meal> getAllFiltered(int userId, Predicate<Meal> filter) {
        List<Meal> meals = jdbcTemplate.query("SELECT * FROM meals ORDER BY datetime DESC", MEAL_ROW_MAPPER);
